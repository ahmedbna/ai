    ...
    <header className={'flex h-[var(--header-height)] items-center overflow-x-auto overflow-y-hidden border-b p-5'}>
      <div className='z-40 flex cursor-pointer items-center gap-4 text-content-primary'>
        ...
        <a href='/'>
          ...
          <img src='/bna-logo.png' alt='BNA logo' width={72} height={42} className='relative -top-1' />
        </a>
        <a
          href='https://github.com/get-convex/chef'
          target='_blank'
          rel='noopener noreferrer'
          className='focus-visible:border-border-selected relative hidden cursor-pointer select-none items-center gap-1.5 whitespace-nowrap rounded-md border bg-background-secondary p-1 text-sm font-medium text-content-primary transition-colors hover:bg-background-primary focus-visible:border focus-visible:outline-none sm:flex'
        >
