  ...
  return (
    ...
    >
      ...
      <div className='flex w-full flex-col justify-between gap-2 p-4 transition-opacity sm:flex-row'>
        <div className='flex items-top gap-2 font-display text-sm font-medium text-content-tertiary'>
          <a
            href='https://bolt.new'
          ...
          <a href='https://www.convex.dev' className='transition-colors hover:text-content-primary' aria-label='Convex'>
            <svg
              width='223'
              height='37'
              viewBox='0 0 223 37'
            ...
            >
              ...
              <path
                ...
                fill='currentColor'
              />
              <path d='M207.931 1.43164H221.765L211.147 16.3176L204.122 6.77854L207.931 1.43164Z' fill='currentColor' />
            </svg>
          </a>
        </div>
      </div>
